<template>
    <Popover v-model:open="open">
        ...
        <PopoverContent class="w-auto p-2">
            <div class="flex gap-4 sm:flex-row flex-col border-b">
                <!-- 左侧年份面板 -->
                <div class="flex flex-col gap-2 p-4">
                    <div class="flex justify-between items-center px-2">
                        <Button variant="ghost" @click="handleYearChange('prev')">
                            <Icon name="famicons:caret-back" class="w-7 h-7"></Icon>
                        </Button>
                ...
                <div class="flex flex-col gap-2 p-4">
                    <div class="flex justify-between items-center px-2">
                        ...
                        <Button variant="ghost" @click="handleYearChange('next')">
                            <Icon name="mage:caret-right-fill" class="w-7 h-7"></Icon>
                        </Button>
                    </div>
                    <div class="grid grid-cols-3 gap-1">
                        <Button v-for="month in months" :key="month" variant="ghost"
            ...
            <span class="dark:text-gray-400 text-gray-500">请选择一年内的数据展示</span>
        </PopoverContent>
    </Popover>
</template>
